...
export default function Changelogs() {
	return (
		<>
			<Head>
				<title>
					Changelogs - Perubahan dan Perkembangan Raja Ongkir Bradeer
				</title>
				<meta
					name="Changelogs Raja Ongkir Bradeer"
					content="Semua perubahan dan perkembangan Raja Ongkir Bradeer bisa kamu lihat disini. Mulai dari perubahan pada produk, perubahan pada website, dan perubahan lainnya."
				/>
